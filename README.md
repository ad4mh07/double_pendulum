...
$$
\dot\omega_1 = \frac{-g(2m_1 + m_2)\sin\theta_1 - m_2 g \sin(\theta_1 - 2\theta_2) - 2m_2 \sin(\delta)\left(\omega_2^2 l_2 + \omega_1^2 l_1 \cos\delta\right)}{l_1\left(2m_1 + m_2 - m_2\cos(2\delta)\right)}
$$
